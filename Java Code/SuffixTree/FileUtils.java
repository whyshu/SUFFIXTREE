...
public class FileUtils {
    ...
    public LinkedHashMap<String, String> putInHashMap(String PatternFileName) {
        String cntOfPatterns = null;
        //Declare a linked hashmap to maintain the order
        LinkedHashMap<String, String> patternHashMap = new LinkedHashMap<>();
    ...
    public void printMap(HashMap mapToPrint) {
